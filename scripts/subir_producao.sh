...
# Rodado DEPOIS que a homologacao ja foi validada.
# Usa a mesma imagem que a homologacao usa.
# ============================================================
set -e
source "$(dirname "$0")/config.sh"

# Garante que a imagem existe (constroi se ainda nao tiver)
...
# Cria o banco (aplica as migracoes)
